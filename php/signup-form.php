        ...
        <form action="signup.php" method="POST">
            ...
            <div class="w-100 px-3" style="max-width: 400px;">
                ...
                <div class="text-center mb-2">
                     <img src="img/logo.png" alt="Logo di AlmaNotes" width="70" height="70"/><h1 class="fw-bold mb-4" style="color: #BB2E29;">Registrati</h1>
                </div>
                ...
                <div class="d-grid">
                    <input type="submit" class="btn btn-lg fw-bold py-2 rounded-3 shadow m-0 fs-4" style="background-color: #BB2E29; color: white;" value="Registrati"/>
                </div>
